...
export const initLayoutConfig = {
  ...
  self: {
    ...
    logo: {
      dark: toAbsoluteUrl("/media/logos/admin-logo.png"),
      light: toAbsoluteUrl("/media/logos/admin-logo.png"),
      brand: toAbsoluteUrl("/media/logos/admin-logo.png"),
      green: toAbsoluteUrl("/media/logos/admin-logo.png")
    }
  },
  // == Portlet Plugin
  // portlet: {
