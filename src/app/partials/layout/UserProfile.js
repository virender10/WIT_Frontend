      ...
      <Dropdown className="kt-header__topbar-item kt-header__topbar-item--user" drop="down" alignRight>
          ...
          <div className="kt-header__topbar-user">
            ...
            {showHi && (
              <span className="kt-header__topbar-username kt-hidden-mobile">
                {/* {user.fullname}Admin */}{user.first_name} 
              </span>
            )}

            {showAvatar && <img alt="Pic" src={user.image} />}
        ...
        <Dropdown.Menu className="dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
          ...
          >
            ...
            <div className="kt-user-card__name">{user.first_name}</div>
          ...
          <Link to="/admin-management/adminProfile" className="kt-notification__item">
